...
<head>
    ...
    <title>Gestionar intercambios en curso.</title>
...
<body class="cream_ours_color_dark">
    ...
    <nav class="cooper_ours_color_dark z-depth-3">
        ...
        <a href="#" class="brand-logo hide-on-small-only">&nbsp;&nbsp;&nbsp;Intercambios en curso.</a>
        <a href="index.php" data-target="slide-out" class="sidenav-trigger"><i class="material-icons">arrow_back</i></a>
        <p class="titleMobile flow-text hide-on-med-and-up">Intercambios en curso.</p>
